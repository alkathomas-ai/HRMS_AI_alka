...
const SuggestionCard = ({
  ...
  return (
    <div
      className={`ai-resource-suggestion-card ${scoreClass}-score ${expanded ? "expanded" : ""}`}
    >
      <div
        className="ai-resource-suggestion-row"
        onClick={() => setExpanded(!expanded)}
      >
        <div
          className={`ai-resource-suggestion-score-circle ${expanded ? "expanded" : ""}`}
        >
          ...
          <div className="ai-resource-score-center">
            ...
            {/* {expanded && (
              <span className="ai-resource-score-label">Total score</span>
            )} */}
          </div>
        </div>

        <div
          className={`ai-resource-suggestion-content ${expanded ? "expanded" : ""}`}
        >
              ...
              {Object.entries(employee.ai_criteria).map(([criteria, score]) => {
                ...
                return (
                  <div key={criteria} className="ai-resource-criteria-row">
                    <span className="ai-resource-criteria-name">
                      {criteria}
                    </span>
              ...
              <div className="ai-resource-skills-container">
                  ...
                  .map((skill, i) => {
                    ...
                    return (
                      <span
                        ...
                        className={
                          isActive
                            ? "ai-resource-skill-badge active-skill-badge"
                            : "ai-resource-skill-badge"
                        }
                      >
                        {trimmed}
                      </span>
                ...
                {skill_set.split(",").length > 6 && (
                  <button
                    ...
                    className="ai-resource-skill-more-btn"
                  >
                    {showAllSkills
                      ? "Show Less"
